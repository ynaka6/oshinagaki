...
return [
    ...
    */
    ...
    'file_extension'       => ':attributeには、拡張子「:values」のファイルを指定してください。',
    'gt'                   => [
        'numeric' => ':attributeには、:valueより大きな値を指定してください。',
        'file'    => ':attributeには、:value kBより大きなファイルを指定してください。',
        'string'  => ':attributeは、:value文字より長く指定してください。',
        'array'   => ':attributeには、:value個より多くのアイテムを指定してください。',
        'date'    => ':attributeには:date以前の日付を指定してください。',
    ],
    'gte'                  => [
        ...
        'date'    => ':attributeには:dateかそれ以前の日付を指定してください。',
    ],
    ...
    'lt'                   => [
        ...
        'date'    => ':attributeには:date以降の日付を指定してください。',
    ],
    'lte'                  => [
        ...
        'date'    => ':attributeには:dateかそれ以降の日付を指定してください。',
    ],
    'max'                  => [
    ...
    |
    */
    'zipcode' => '郵便番号は、数字3桁-数字4桁を指定してください。',
    'birthday' => '生年月日が不正です。日付が正しいか確認してください。',
    'job_number' => '求人番号は半角英数字および「-（ハイフン）」/15文字以内で入力してください。',
    'custom' => [
        'attribute-name' => [
